...
```
print(hist(total_steps$steps, breaks = 20, xlab = "No. of Steps Taken", main = "Total No. of Steps Per Day", family = "serif"))
```
...
```
print(plot(x = mean_steps_interval$interval, y = mean_steps_interval$steps, type = "l", main = "Average Steps Taken Per Interval", xlab = "No. of Steps", ylab = "Intervals in 5 Minutes", lwd = 1.5, family = "serif"))
```
...
print(hist(imput_total_steps_day$steps, breaks = 20, xlab = "No. of Steps Taken", main = "Total No. of Steps Per Day With Replaced NA Values", family = "serif"))
```
...
```
par(mfrow = c(2, 1))
print(plot(weekdays_mean$interval, weekdays_mean$steps, type = "l",
     main = "Time Series Plot of Average Steps Taken per Interval for Weekdays",
     xlab = "Intervals", ylab = "Number of Steps"))
print(plot(weekends_mean$interval, weekends_mean$steps, type = "l",
